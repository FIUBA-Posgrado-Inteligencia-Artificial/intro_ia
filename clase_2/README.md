# Clase 2 - PCA y K-means
En ésta clase se seguirán aplicando los conocimientos prácticos de Numpy en dos
algoritmos no supervisados como PCA y K-means. Se va a abordar K-means desde un
enfoque práctico mientras que para PCA se realizará el desarrollo matemático completo.


## Teoría
* [Presentación](presentaciones/clase_2.pdf)
* [Video Introducción a PCA](https://drive.google.com/file/d/1awBzrhlaQSow5NzMQWdVb37ajXbf0T3B/view?usp=sharing)
...
* [Dimensionality Reduction - Principal Component Analysis](https://medium.com/analytics-vidhya/dimensionality-reduction-principal-component-analysis-d1402b58feb1)
* [PCA-based Object Recognition](http://www.cse.psu.edu/~rtc12/CSE486/lecture32.pdf)