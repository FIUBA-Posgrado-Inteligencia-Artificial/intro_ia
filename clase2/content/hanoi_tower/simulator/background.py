...
def draw_pegs(display: pygame.Surface, color=(130, 130, 130)):
    ...
    - color (tuple): RGB color tuple representing the color of the pegs. Default is
        (130, 130, 130).
    """
    ...
    pygame.draw.rect(
        display,
        color,
        pygame.Rect(BASE_LEFT, BASE_TOP, SCREEN_WIDTH - 2 * BASE_LEFT, PEGS_WIDTH),
    )
    pygame.draw.rect(
        display, color, pygame.Rect(peg_1_left, PEGS_TOP, PEGS_WIDTH, PEGS_HEIGHT)
    )
    pygame.draw.rect(
        display, color, pygame.Rect(peg_2_left, PEGS_TOP, PEGS_WIDTH, PEGS_HEIGHT)
    )
    pygame.draw.rect(
        display, color, pygame.Rect(peg_3_left, PEGS_TOP, PEGS_WIDTH, PEGS_HEIGHT)
    )
