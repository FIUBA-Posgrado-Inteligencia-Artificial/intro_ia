...
def initialize_logic(initial_state: dict, disk_height: int) -> HanoiBaseLogic:
    ...
    Returns:
    - HanoiBaseLogic: An instance of the HanoiBaseLogic class initialized with the
        provided initial state and disk height.
    """

    hanoi_base = HanoiBaseLogic((PEG_LEFT_CENTER, PEG_CENTER_CENTER, PEG_RIGHT_CENTER))

    for peg_name, disks in initial_state.items():
